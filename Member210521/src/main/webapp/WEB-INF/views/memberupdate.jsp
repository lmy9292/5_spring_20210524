...
<script>
 	function updatefn(){
 		...
 		//사용자 입력값
 		var passwordConfirm= document.getElementById('qwd').value;//사용자가 입력한 비번
...
<body>
	...
	<!--readonly: 아이디를 못바꾸게 하는것  -->
	비밀번호:<input type="text" name="mpassword" id="qwd"><br>
	...
	<!--type을 submit으로 하거나 button태그를 클릭하면 form태그 내용이 바로 전성됨  -->
